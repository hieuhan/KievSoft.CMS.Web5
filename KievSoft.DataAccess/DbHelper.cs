...
namespace KievSoft.DataAccess
{
    public class DbHelper
    {
        ...
        public void AddOutParameter(DbCommand dbCommand, string parameterName, DbType dbType, int size = 0)
        {
            DbParameter dbParameter = dbCommand.CreateParameter();
            dbParameter.DbType = dbType;
            dbParameter.ParameterName = parameterName;
        ...
        public void AddInputOutputParameter(DbCommand dbCommand, string parameterName, DbType dbType, object value)
        {
            DbParameter dbParameter = dbCommand.CreateParameter();
            dbParameter.DbType = dbType;
            dbParameter.ParameterName = parameterName;
